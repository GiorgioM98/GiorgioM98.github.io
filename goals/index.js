...
document.addEventListener("DOMContentLoaded", function() {
      const elements = document.querySelectorAll(".title, .fs-6");
    ...
          if (distanceFromTop < window.innerHeight * 0.90) {
    ...
    const titolo= document.querySelectorAll("span");
    titolo.forEach(element => {
        element.addEventListener("mouseover", function(){
            this.style.color= "#DCFE50";
        })
    })
